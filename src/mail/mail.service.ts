...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f7fa;">
  ...
  async sendGroupMemberAddedEmail(data: GroupMemberAddedData) {
  ...
  async sendTaskAssignedEmail(data: TaskAssignedData) {
  ...
  async sendTaskCompletedEmail(data: TaskCompletedData) {
    const taskUrl = `${this.frontendUrl}/groups/${data.groupId}/projects/${data.projectId}`;
