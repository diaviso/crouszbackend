...
let TasksController = class TasksController {
    ...
    findAllByProject(projectId, page, limit, search, status, user) {
    ...
    assignUser(id, assigneeId, user) {
        return this.tasksService.assignUser(id, assigneeId, user.id);
    }
    unassignUser(id, assigneeId, user) {
...
__decorate([
    ...
    __param(5, (0, decorators_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, String, Object]),
    __metadata("design:returntype", void 0)
], TasksController.prototype, "findAllByProject", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, common_1.Post)(':id/assignees/:userId'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, common_1.Delete)(':id/assignees/:userId'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Param)('userId')),
    __param(2, (0, decorators_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", void 0)
], TasksController.prototype, "unassignUser", null);
